...
if (isset($_POST['Deactivate']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_member_ach set status='0' where id='$act'");
	}
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_member_ach set status='1' where id='$act'");
	}
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "delete from tbl_member_ach where id='$act'");
	}
}

$mqry = "select * from tbl_member_ach ";
...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;"> Member Achievements Management</a></li>
				<li class="breadcrumb-item active">Manage Member Achievements</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
				...
				<div class="col-lg-12">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							...
							<h4 class="panel-title">Manage Member Achievements</h4>
						</div>
						<!-- end panel-heading -->
						<form name="myform" method="post" action="">
							...
							<div class="alert alert-secondary fade show">
								...
								<div class="btn-group btn-group-justified">
									<a href="add-member-achievements.php" class="btn btn-default active"><i class="fa fa-plus"></i>
										Add New Member Achievement</a>
										...
										<tbody>
											...
											while ($web = mysqli_fetch_array($fetch)) {
												...
												<tr class="odd gradeX">
													...
													<td width="1%" class="with-img"><?php if ($web['icon'] == 0) { ?><img
														src="../uploads/no.png"
														class="img-rounded height-80" /><?php } else { ?><img
														src="../uploads/members/<?php echo $web['icon']; ?>"
														class="img-rounded height-80" /><?php } ?>
													</td>
													<td style="font-weight:700; color:#000;"><?= $web['numbers']; ?></td>
													...
													<td>
														<a href="edit-member-achievements.php?bid=<?php echo $web['id']; ?>"
															class='label label-sm label-primary' title="Edit"><i
																class="fa fa-edit"></i> Edit</a>
													</td>
													<td>
														<a href="delete/member-achievements.php?bid=<?php echo $web['id']; ?>"
															onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }"
	...
	<script>
		function updateId(id) {
			...
			xmlhttp.open("GET", "status/member-achievements.php?id=" + id, true);
			xmlhttp.send();
		}
	</script>
	<!----------------Check Box----------------------->
