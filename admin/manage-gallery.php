...
if (isset($_POST['Deactivate']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_gallery set status='0' where id='$act'");
	}
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) {	
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_gallery set status='1' where id='$act'");
	}
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) { 
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "delete from tbl_gallery where id='$act'");
	}
}

$mqry = "select * from tbl_gallery ";
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-heading">
							<div class="panel-heading-btn">
								...
								<a href="javascrip	t:;" class="btn btn-xs btn-icon btn-circle btn-success" data-click="panel-reload"><i class="fa fa-refresh"></i></a>
						...
						<form name="myform" method="post" action="">
							...
							<div class="alert alert-secondary fade show">
								...
								<div class="btn-group btn-group-justified">
									<a href="add-gallery.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Gallery</a>
										...
										<tbody>
											...
											?>
												<tr class="odd gradeX">
                                                    ...
                                                    <td width="1%" class="with-img"><img src="../uploads/gallery/<?php echo $web['image']; ?>" class="img-rounded height-60" /></td>
													...
													<td>
														<a href="edit-gallery.php?bid=<?php echo $web['id']; ?>" class='label label-sm label-primary' title="Edit"><i class="fa fa-edit"></i> Edit</a>
													</td>
													<td>
														<a href="delete/gallery.php?bid=<?php echo $web['id']; ?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
													</td>
													<td width="1%">
