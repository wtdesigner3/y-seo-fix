...
if(isset($_POST['Deactivate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update projects set status='0' where id='$act'");
		}
}
...
if(isset($_POST['Activate']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"update projects set status='1' where id='$act'");
		}
}		
...
if(isset($_POST['Delete']) && $bb!='')
{
		foreach($bb as $act)
		{
			mysqli_query($conn,"delete from projects where id='$act'");
		}
}
		
		$mqry="select * from projects";
...
<body>	
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Manage Projects </h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
                       ...
                       <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-testimonial.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add Project</a>
						...
						<div class="panel-body">
							<table id="data-table-responsive" class="table table-striped table-bordered">
			                    ...
			                    ?>
									...
									<?php
										if($web['image'] != ''){
									$images = explode(",", $web['image']);
									$imgforshowing = $images[0];
									?>
										<td style="font-weight:700;" class="f-s-600 text-inverse"><img src="../uploads/<?= $imgforshowing; ?>" style="width:20%;"></td>
									<?php
										 }
									?>
										<td style="font-weight:700;" class="f-s-600 text-inverse"><?= $web['name1'];?></td>
										...
										<td>
                                          <a href="delete/testimonial.php?bid=<?php echo $web['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
                                         </td>
                                        <td>
