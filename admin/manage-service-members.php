...
if (isset($_POST['Dectivate']) && isset($_POST['bb'])) 
{
    $bb = $_POST['bb'];
    foreach ($bb as $act) {
        mysqli_query($conn, "update sub_sub_categories  set status='0' where id='$act'");
    }
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) 
{
    $bb = $_POST['bb'];
    foreach ($bb as $act) {
        mysqli_query($conn, "update sub_sub_categories  set status='1' where id='$act'");
    }
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) 
{
    $bb = $_POST['bb'];
    foreach ($bb as $act) {
        mysqli_query($conn, "DELETE FROM sub_sub_categories WHERE id=$act");
    }
}
...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
                     ...
                     <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-service-members.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Product</a>
							...
							<table id="data-table-responsive" class="table table-striped table-bordered">
								<thead>
									<tr>
										...
										<th class="text-nowrap">Bread Heading</th>
                                ...
                                ?>
									<tr class="odd gradeX">
									   ...
									   <td width="10%" class="with-img"><?= $web['Sub_name']; ?></td>
                                       <td style="font-weight:700; color:#000;"><?= $web['name']; ?></td>
									   <td style="font-weight:700; color:#000;"><img src="../uploads/<?php echo $web['image']; ?>" class="img-rounded height-60" /></td>
									   <td style="font-weight:700; color:#000;"><?= $web['bread_heading']; ?></td>									 
										<td>
                                          <div class="switcher">
        ...
        echo "checked";
										...
										<td>
                                          <a href="edit-service-members.php?bid=<?php echo $web['id']; ?>" class='label label-sm label-primary' title="Edit"><i class="fa fa-edit"></i> Edit</a>
                                        </td>
                                        <td>
                                          <a href="delete/service-members.php?bid=<?php echo $web['id']; ?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
                                         </td>
                                        <td width="1%">
    ...
    <script>
	  function updateId(id)
	  {
		  ...
		  xmlhttp.open("GET", "status/service-members.php?id=" +id, true);
		  xmlhttp.send();
	  }
   </script>
    <!----------------Check Box-----------------------> 
