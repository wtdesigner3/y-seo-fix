...
if (isset($_POST['Dectivate']) && isset($_POST['bb'])) 
{
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update sub_categories set status='0' where id='$act'");
	}
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) 
{
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update sub_categories  set status='1' where id='$act'");
	}
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) 
{
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "DELETE FROM sub_categories WHERE id=$act");
	}
}

$mqry = "select * from sub_categories ";
                     ...
                     <form name="myform" method="post" action=""> 
						...
						<div class="alert alert-secondary fade show">
							...
							<div class="btn-group btn-group-justified">
                              <a href="add-service.php" class="btn btn-default active"><i class="fa fa-plus"></i> Add New Sub Category</a>
...
?>
									<tr class="odd gradeX">
									   ...
									   <td width="10%" class="with-img"><img src="../uploads/<?php echo $web['image']; ?>" class="img-rounded height-60" /></td>
                                       <td style="font-weight:700; color:#000;"><?= $web['name']; ?></td>
