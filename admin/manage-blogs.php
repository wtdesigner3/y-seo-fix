...
if(isset($_POST['Deactivate']) && isset($_POST['bb']))
{
  ...
  foreach($bb as $act)
  {
	  mysqli_query($conn,"update posts set status='0' where id='$act'");
  }
}
if(isset($_POST['Activate']) && isset($_POST['bb']))
{
  ...
  foreach($bb as $act)
  {
	  mysqli_query($conn,"update posts set status='1' where id='$act'");
  }
}
if(isset($_POST['Delete']) && isset($_POST['bb']))
{
  ...
  foreach($bb as $act)
  {
	  mysqli_query($conn,"delete from posts where id='$act'");
  }
}		
?>
<!DOCTYPE html>
						...
						<div class="panel-body">
                         <div class="table-responsive">
							<table id="data-table-responsive" class="table table-striped table-bordered">
								...
								<tbody>
                                <?php
								     $mqry="select * from posts order by id desc"; 
								     $count=1; 
			                    ...
			                    ?>
									<tr class="odd gradeX">
										...
										<td width="1%" class="with-img"><img src="../uploads/<?php echo $web['image']; ?>" class="img-rounded height-60" /></td>
										<td  width="50%" style="font-weight:500; color:#000;"><?= $web['title'];?></td>
										<td  width="50%" style="font-weight:500; color:#000;"><?= $web['sort_order'];?></td>
										...
										<td>
											<a href="edit-blogs.php?bid=<?php echo $web['id'];?>" class='label label-sm label-primary' data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i> Edit</a>
										</td>                                        
										<td>
											<a href="delete/blogs.php?bid=<?php echo $web['id'];?>" onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }" data-toggle="tooltip" title="Delete" class='label label-sm label-danger'><i class="fa fa-trash"></i> Delete</a>
										</td>
										 <td width="1%">
