...
//=============|image|============//
	...
	if($bimages!="")
	{
		...
		move_uploaded_file($_FILES["ach_image"]["tmp_name"], "../uploads/news/".$bimage);
	}
	else
	{
		$bimage="";	
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_news`(`title`,`url`,`image`,`sort`, `status`) VALUES ('$title','$url','$bimage','$position','$status')");
    if($query==true)
    {
		...
		<div id="content" class="content">
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">
			 ...
			 <div class="form-group">
				...
				<input type="text" name="url" class="form-control" id="" placeholder="Enter Url" >
			</div>
