...
if (isset($_POST['Deactivate']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_about set status='0' where id='$act'");
	}
}
...
if (isset($_POST['Activate']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "update tbl_about set status='1' where id='$act'");
	}
}
...
if (isset($_POST['Delete']) && isset($_POST['bb'])) {
	$bb = $_POST['bb'];
	foreach ($bb as $act) {
		mysqli_query($conn, "delete from tbl_about where id='$act'");
	}
}

$mqry = "select * from tbl_about ";
...
<body>
	...
	<div id="page-container" class="fade in page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;"> About Management</a></li>
						...
						<form name="myform" method="post" action="">
							...
							<div class="alert alert-secondary fade show">
								...
								<div class="btn-group btn-group-justified">
									<a href="add-about.php" class="btn btn-default active"><i class="fa fa-plus"></i>
										Add New About</a>
											...
											while ($web = mysqli_fetch_array($fetch)) {
												...
												<tr class="odd gradeX">
													...
													<td width="1%" class="with-img"><?php if ($web['image'] == 0) { ?><img
														...
														src="../uploads/about/<?php echo $web['image']; ?>"
														class="img-rounded height-80" /><?php } ?>
													<td style="font-weight:700; color:#000;"><?= $web['heading']; ?></td>
													<td style="font-weight:700; color:#000;"><?= $web['subheading']; ?></td>
													...
													<td>
														<a href="edit-about.php?bid=<?php echo $web['id']; ?>"
															class='label label-sm label-primary' title="Edit"><i
																class="fa fa-edit"></i> Edit</a>
													</td>
													<td>
														<a href="delete/about.php?bid=<?php echo $web['id']; ?>"
															onClick="if(confirm('Are You Sure Want To Delete This Record')){ return true;} else { return false; }"
	...
	<script>
		function updateId(id) {
			...
			xmlhttp.open("GET", "status/about.php?id=" + id, true);
			xmlhttp.send();
		}
	</script>
	<!----------------Check Box----------------------->
