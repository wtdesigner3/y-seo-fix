...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($conn,"INSERT INTO `tbl_case_study`(`b_title`, `b_description`, `b_status`,`b_sort`) VALUES ('$title','$desc','$status','$sort')");
	if($query==true)
	{
		...
		<div id="content" class="content">
			...
			<form role="form"  method="POST"  enctype="multipart/form-data">
			  ...
			  <div class="form-group">
				...
				<div class="form-group">
                    <label for="heading">Faq Description</label>
                    <textarea  name="desc" class="form-control" rows="5"  placeholder="Enter Faq Description" required></textarea>
                </div>

			  <div class="form-group">
                  <label for="title"> Faq Sort</label>	
                  <input type="text" name="sort" class="form-control" placeholder="Enter  Faq Sort">
                </div>				
