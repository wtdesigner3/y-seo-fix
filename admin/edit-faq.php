...
$b=$_REQUEST['cid'];
$bdata=mysqli_query($conn,"SELECT * FROM `faq_table` where `id`='$b'");
...
if(isset($_POST['update']))
{
   ...
   $query=mysqli_query($conn,"UPDATE `faq_table` SET `category_id`='$category_id', `faq_question`='$faq_question', `faq_answer`='$faq_answer', `sort`='$sort', `status`='$status' WHERE `id`='$b'");
      if($query==true)
      {
...
<body>
	...
	<?php require("includes/left.php"); ?>
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header"><a href="javascript:;" onClick="javascript:history.go(-1)" class="btn btn-l btn-icon btn-circle btn-primary" data-click="panel-remove"><i class="fa fa-arrow-left"></i></a> Edit Faq</h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
				<!-- begin col-10 -->
  				...
  				<div class="row">
                   ...
                   <div class="col-sm-6">
						<div class="form-group">
							...
							<input type="text"  name="faq_question" value="<?= $brec['faq_question']; ?>" class="form-control" placeholder="Enter FAQ Question">
						</div>
				  </div>
             	  ...
             	  <div class="col-sm-12">
						<div class="form-group">
							...
							<textarea name="faq_answer" class="form-control" id="editor1" placeholder="Enter FAQ Answer"><?= $brec['faq_answer']; ?></textarea>
						</div>
				  </div>
